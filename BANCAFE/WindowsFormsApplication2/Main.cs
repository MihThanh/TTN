...
namespace WindowsFormsApplication2
{
    public partial class Main : Form
    {
        ...
        private void but_ncc_Click(object sender, EventArgs e)
        {
            if (!panel.Controls.Contains(NCC.Instance))
            {
                panel.Controls.Add(NCC.Instance);
                NCC.Instance.Dock = DockStyle.Fill;
                NCC.Instance.BringToFront();
            }
            else
                NCC.Instance.BringToFront();
        }
        ...
        {
            if (!panel.Controls.Contains(user_loai.Instance))
            {
                panel.Controls.Add(user_loai.Instance);
                user_loai.Instance.Dock = DockStyle.Fill;
                user_loai.Instance.BringToFront();
            }
            else
                user_loai.Instance.BringToFront();
        }
